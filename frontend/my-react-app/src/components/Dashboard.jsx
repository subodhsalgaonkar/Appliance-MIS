        ...
        <div className="min-h-screen flex flex-col">
            ...
            <header className="bg-gray-800 text-white py-4 px-6 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm">{userData.u_id}</p>
                </div>
                <div>
            ...
            <main className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {groups.map(group => (
                        <Link key={group.g_id} to={`/appliance`} className="text-gray-900" onClick={() => handleGroupClick(group.g_id)}>
                            <div className="bg-white shadow-md p-4 rounded-md cursor-pointer">
                                <h3 className="text-lg font-semibold mb-2">Group {group.g_id} {group.g_name}</h3>
