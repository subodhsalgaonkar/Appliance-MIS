...
const Appliance = () => {
    ...
    const handleApplianceClick = (a_id) => {
        // Save the apliance ID to local storage
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <header className="bg-gray-800 text-white py-4 px-6 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm">u_id: {userData.u_id}</p>
                </div>
                <div>
            ...
            <main className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {appliances.filter(appliance =>
                        ...
                        <Link key={appliance.a_id} to={`/appliance-details`} className="text-gray-900" onClick={() => handleApplianceClick(appliance.a_id)}> 
                            <div key={appliance.a_id} className="bg-white shadow-md p-4 rounded-md">
